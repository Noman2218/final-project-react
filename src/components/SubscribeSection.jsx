...
const SubscribeSection = () => {
    ...
    return (
        <div className="flex justify-center">
            ...
            >
                <div className="bg-transparent p-8 rounded-lg text-balance shadow-lg z-10 max-w-screen-sm">
                    <h3 className="text-md font-bold mb-4">Subscribe now and receive weekly newsletters with educational materials, new courses, interesting posts, and much more!</h3>
                    <form onSubmit={handleSubscribe} className="flex justify-center">
                        ...
                        <button
                            type="submit"
                            className="bg-blue-500 text-white p-2 rounded-r-md hover:bg-blue-600 transition text-sm" // Adjust button text size here
                        >
                            Subscribe
                        </button>
                    </form>
