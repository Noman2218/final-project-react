...
const ITCapstoneWrittenProject = () => {
  return (
    ...
    <div className="bg-gray-100 min-h-screen">
        ...
        <div className="max-w-7xl mx-auto p-4">
            ...
            <header className="mb-6">
                <h1 className="text-4xl mb-2 font-bold">IT Capstone Written Project</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <main className="lg:col-span-2 space-y-4">
                    ...
                    <div className="bg-white rounded-lg overflow-hidden shadow-lg">
                        <img src="/images/edue-lead-web-dev.jpg" alt="Course" className="w-full" />
                    </div>
...
export default ITCapstoneWrittenProject
